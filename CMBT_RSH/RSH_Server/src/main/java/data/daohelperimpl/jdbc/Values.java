...
public class Values {
    ...
    public static final String URL = "jdbc:mysql://localhost:3306/OurData?"
            + "user=root&password=CMBT4142&useUnicode=true&characterEncoding=utf8&autoReconnect=true&failOverReadOnly=false&useSSL=true";//数据库Url,用来标识要连接的数据库，其中数据库名、用户名、密码是根据你自己的数据库情况设定
